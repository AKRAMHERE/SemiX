...
silicon_diode.plot_vi_with_power(voltage_range=(-5, 5), steps=100)
...
silicon_diode.plot_bandgap_vs_temperature()
silicon_diode.plot_junction_capacitance_vs_voltage()
silicon_diode.plot_conductance_vs_voltage()
...
germanium_diode.plot_bandgap_vs_temperature()
germanium_diode.plot_junction_capacitance_vs_voltage()
germanium_diode.plot_conductance_vs_voltage()
