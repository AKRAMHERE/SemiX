...
silicon_diode.plot_v_with_power(voltage_range=(-2, 2))
...
germanium_diode.plot_v_with_power(voltage_range=(-2, 2), steps=50)
...
gaas_diode.plot_v_with_power(voltage_range=(-5, 2), steps=50)
gaas_diode.plot_noise_vs_temperature()
gaas_diode.plot_bandgap_vs_temperature(gaas_diode)
gaas_diode.plot_junction_capacitance_vs_voltage()
gaas_diode.plot_conductance_vs_voltage(gaas_diode)
gaas_diode.plot_drift_diffusion_currents()
